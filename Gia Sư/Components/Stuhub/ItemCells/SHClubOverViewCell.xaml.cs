...
namespace Gia_Sư.Components.Stuhub.ItemCells
{
    public sealed partial class SHClubOverViewCell : UserControl
    {
        ...
        public static readonly DependencyProperty DateProperty =
            DependencyProperty.Register("Date", typeof(DateTime), typeof(SHClubOverViewCell), null);
