            ...
            try
            {
                ...
                for (int i = 0; i < Particles.Count; i++)
                {
                    for (int j = i + 1; j < Particles.Count; j++)
                    {
                        ...
                        if (range < 120)
                        {
                            args.DrawingSession.DrawLine(Particles[i].Offset.ToVector2(), Particles[j].Offset.ToVector2(), _LineColor, (220f - range) / 80f);
                        }
                    }
                    if (_IsPointerEnable && IsPointerIn)
                    {
                        ...
                        if (pointerRange < 120)
                        {
                            args.DrawingSession.DrawLine(Particles[i].Offset.ToVector2(), PointerPosition, _LineColor, (220f - pointerRange) / 80f);
                            if (pointerRange > 80)
                            {
