...
namespace Gia_Sư.Helpers
{
    internal class Particle
    {
        ...
        public Particle(Vector3 Container, Vector3 Head, Vector3 Offset)
        {
            _Step = 0;
        ...
        {
            var _Container = new Vector3(Container.X, Container.Y, rnd.Next(100, 210));
            ResetOffset(_Container);
        }

        public static Particle CreateParticle(Vector2 Container)
        {
            return CreateParticle(Container.X, Container.Y, rnd.Next(100, 210));
        }
        public static Particle CreateParticle(double Width, double Height, double Depth)
        {
        ...
        public static Particle CreateParticle(float Width, float Height, float Depth)
        {
            var Container = new Vector3(Width, Height, Depth);
            return CreateParticle(Container);
        }
        public static Particle CreateParticle(Vector3 Container)
        {
            ...
            var particle = new Particle(Container, head, offset);
            return particle;
        }
    }
}
